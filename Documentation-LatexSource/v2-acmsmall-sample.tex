...
\section{Conclusions}
In this paper, we focused on spatial aspects of Databases. We examined their general use and the various fields of science and commerce that they can be applied. Later we presented the basic operations and modelling of spatial entities along with query processing and indexing. Finally we presented the most popular NoSQL databases and examined their geospatial capabilities.
