...
% Page heads
\markboth{}{A General Framework for Geo-Social Query Processing: An Experimental Evaluation}

% Title portion
\title{A General Framework for Geo-Social Query Processing: An Experimental Evaluation}
